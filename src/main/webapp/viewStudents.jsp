...
<main>
    <div class="overlay">
        <h2 class="table-heading">Your Grades</h2>
        ...
        <%
            ...
            try {
                ...
                String sql = "SELECT semester, subject, grade FROM Grades WHERE studentId = ? ORDER BY semester";
        ...
        %>
                    <tr>
                        <td colspan="3" class="text-center no-records">No grades available.</td>
                    </tr>
        <%
                }
